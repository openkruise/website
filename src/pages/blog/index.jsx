    ...
    return (
      <div className="blog-list-page">
        <Header
          type="normal"
          currentKey="blog"
          logo={getLink('/img/kruise_colorful.png')}
          language={language}
          onLanguageChange={this.onLanguageChange}
        />
        <Bar img={getLink('/img/system/blog.png')} text={dataSource.barText} />
        ...
        <Footer logo={getLink('/img/kruise_gray.png')} language={language} />
      </div>
    );
  }
}
